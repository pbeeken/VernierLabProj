...
/**
   Like setup() and loop() this function is an ISR that is triggered
   whenever there is a character in the serial port buffer. You can put
   what ever you want in this routine but it should concern itself
   with gathering characters in the small buffer.
**/
void serialEvent() {
   // We get here because there is a character in the buffer.
   // In reality we don't really need to test if there are
